export const FAQ_CONTENT = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        reponseQuestion:
          "<p>Vous trouverez ci-dessous la liste des produits inclus dans  Parcel-Wallonie (image extraite de la Note méthodologique de l’outil PARCEL, page 5). 61 produits sont répertoriés dans la base de données de PARCEL. Certains produits étant des regroupements de produits (voir la ligne « Betteraves, radis, salsifis, similaires »), le périmètre de  Parcel-Wallonie couvre en réalité environ 90 produits. Les produits pris en compte par  Parcel-Wallonie représentent 91% de notre alimentation en volume. Ne sont pas pris en compte : les produits de la mer, les boissons alcoolisées et les produits tropicaux/exotiques (avocat, café, cacao, etc.).</p><p>Ainsi,  Parcel-Wallonie prend en compte les produits consommés par les Wallonn.e.s, qui ont un potentiel de relocalisation en Wallonie (qu’il est possible de cultiver en Wallonie) (donc les produits recensés à cette échelle dans les données agricoles Statbel), quelle que soit la forme dans laquelle sont consommés ces produits (frais, congelés, incorporés dans des produits transformés complexes…).</p><p>Les boissons alcoolisées (bière, vin) ne sont actuellement pas non plus incluses dans  Parcel-Wallonie, la volonté a été de se concentrer sur les besoins alimentaires primaires.</p>",
      },
      {
        titreQuestion:
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        reponseQuestion:
          "<p>Les valeurs sont mises à jour selon la mise à disposition de nouvelles données disponibles. Actuellement,  Parcel-Wallonie utilise les données du recensement agricole de 2010. Ces données seront actualisées sur la base des résultats du dernier recensement agricole datant de 2020, lorsqu’elles seront disponibles.</p>",
      },
      {
        titreQuestion:
