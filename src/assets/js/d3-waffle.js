    ...
    selection.each(function(data) {
      ...
      nodes.append("text")
            ...
            .style("font-size", function(d) {
             var val = 9;
             var val2 = 2.5;
             var textsize = Math.min(val2 * gridSize, (val2 * gridSize - val) / this.getComputedTextLength() * val);
      ...
      function mouseover(d){
       ...
       var  el = data.filter(function(e){ return e.name == d.name})[0]
       var  txt = "<b>" +el.name + "</b><br>" + d3.format(',')(el.value) + "<br>(" + d3.format(".0%")(el.percent) + ")"
        tooltip.html(txt);
