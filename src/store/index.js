...
export default createStore({
    ...
    mutations: {
        ...
        choisirRegimeAlimentaire(state, regime_alimentaire_nomCourt) {
            state.regime_alimentaire = state.regimeListe.find((el) => el.nomCourt == regime_alimentaire_nomCourt);
        },
    ...
    actions: {
        ...
        async actionChoisirRegimeAlimentaire({ commit }, regimeAlimentaire) {
            ...
            var surfaceNecessaireResponseApi = await fetchSurfaceNecessaire(url, codesTerritoireParcel, regimeAlimentaire.id);
            let resultatSimulation = calculerResultatSimulation(surfaceNecessaireResponseApi);
