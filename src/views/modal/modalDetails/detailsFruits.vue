<template>
  <div class="modal-content modal-repart-cat-detail">
    <div class="modal-header d-flex align-items-center">
      <div><span class="icon-ico_CATEGORIES_fruits icon fruits" /></div>
      ...
      >
        <div class="card-body">
          ...
          >
            ...
            ><span class="icon-ico_poids icon fruits" />
              <div class="info-infos">
                <span class="d-flex flex-column info-intro"><span class="info-entete">Production</span><span class="info-verbe">=</span></span><span class="d-flex flex-column info-detail"><span class="nbr-ha"> 0,7% </span><span class="hectares">de la surface agricole en France métropolitaine</span></span>
              </div>
            </span>
            <span
              class="col-4 d-flex flex-sm-column flex-row justify-content-center"
            ><span class="icon-ico_champ icon fruits" />
              <div class="info-infos">
                <span class="d-flex flex-column info-intro"><span class="info-entete">Consommation</span><span class="info-verbe">=</span></span><span class="d-flex flex-column info-detail"><span class="nbr-ha"> 5,4% </span><span class="hectares">de l’assiette d’un Français moyen (en volume)</span></span>
              </div>
            </span>
            <span
              class="col-4 d-flex flex-sm-column flex-row justify-content-center"
            ><span class="icon-ico_CATEGORIES_fruits icon fruits" />
              <div class="info-infos">
                <span class="d-flex flex-column info-intro"><span class="info-entete">Importation</span><span class="info-verbe">=</span></span><span class="d-flex flex-column info-detail"><span class="nbr-ha"> 43% </span><span class="hectares">
                  des fruits consommés en France métropolitaine sont
                  importés</span></span>
              </div>
            </span>
          </div>
            ...
            <ul>
              <li>
                ...
                <strong>des hectares de terres agricoles qu’il faudrait mobiliser
                  pour satisfaire la consommation en fruits</strong>, compte tenu des paramètres choisis par l’utilisateur (%
